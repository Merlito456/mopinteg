...
NOTE: Only DOC-scope and non-site-specific defaults are kept.
      FIO and EWP values are extracted from uploaded files at runtime.
"""
...
PLACEHOLDER_MAP = [
    ...
    # DOCUMENT METADATA
    # ============================================================
    {"key": "SITE_NAME", "label": "Site Name (Ring)", "source": "FIO", "group": "Document Metadata", "default": ""},
...
{"key": "OLT_SW_VERSION", "label": "OLT SW Version", "source": "DOC", "group": "Network Elements", "default": "L6GQFC24.298"},
{"key": "OLT_SW_VERSION_SHORT", "label": "OLT SW Version (Short)", "source": "DOC", "group": "Network Elements", "default": "24.6"},
    ...
    {"key": "AN_LOOPBACK0", "label": "AN Loopback0", "source": "FIO", "group": "Network Elements"},
    {"key": "AN_LOOPBACK1", "label": "AN Loopback1", "source": "FIO", "group": "Network Elements"},
    ...
    {"key": "AG1_IP", "label": "AG1 IP", "source": "FIO", "group": "Network Elements"},
    {"key": "AG2_IP", "label": "AG2 IP", "source": "FIO", "group": "Network Elements"},
    {"key": "AG1_LOOPBACK0", "label": "AG1 Loopback0", "source": "FIO", "group": "Network Elements"},
    {"key": "AG1_LOOPBACK1", "label": "AG1 Loopback1", "source": "FIO", "group": "Network Elements"},
    {"key": "AG2_LOOPBACK0", "label": "AG2 Loopback0", "source": "FIO", "group": "Network Elements"},
    {"key": "AG2_LOOPBACK1", "label": "AG2 Loopback1", "source": "FIO", "group": "Network Elements"},
    ...
    {"key": "VSI_OM", "label": "OM VSI Name", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VSI_SIP", "label": "SIP VSI Name", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VSI_HSI", "label": "HSI VSI Name", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VSI_IPOE1", "label": "IPOE1 VSI Name", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VSI_IPOE2", "label": "IPOE2 VSI Name", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_OM", "label": "BNG Peer IP (OM)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_SIP", "label": "BNG Peer IP (SIP)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_HSI", "label": "BNG Peer IP (HSI)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_SIP_HSI", "label": "BNG Peer IP (SIP/HSI L2)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_IPOE1", "label": "BNG Peer IP (IPOE1)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "BNG_PEER_IPOE2", "label": "BNG Peer IP (IPOE2)", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_OM_PRIMARY", "label": "VCID OM Primary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_OM_SECONDARY", "label": "VCID OM Secondary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_SIP_PRIMARY", "label": "VCID SIP Primary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_SIP_SECONDARY", "label": "VCID SIP Secondary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_HSI_PRIMARY", "label": "VCID HSI Primary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_HSI_SECONDARY", "label": "VCID HSI Secondary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_IPOE1_PRIMARY", "label": "VCID IPOE1 Primary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_IPOE1_SECONDARY", "label": "VCID IPOE1 Secondary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_IPOE2_PRIMARY", "label": "VCID IPOE2 Primary", "source": "FIO", "group": "VLAN & VSI"},
    {"key": "VCID_IPOE2_SECONDARY", "label": "VCID IPOE2 Secondary", "source": "FIO", "group": "VLAN & VSI"},
    ...
    {"key": "AGG_NODE_SIP_HSI_L2", "label": "AGG Node (SIP/HSI L2)", "source": "FIO", "group": "Node Names"},
    ...
    {"key": "CX600_NODE", "label": "CX600 Node", "source": "FIO", "group": "Node Names"},
